  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-surface rounded-2xl shadow-modal border border-border p-6",
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 rounded-lg p-2 text-muted hover:text-dark hover:bg-background transition-colors">
        <X className="h-4 w-4" />
      </DialogClose>
    </DialogPrimitive.Content>
  </DialogPortal>
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={cn("font-sora text-xl font-semibold text-dark", className)} {...props} />
))
